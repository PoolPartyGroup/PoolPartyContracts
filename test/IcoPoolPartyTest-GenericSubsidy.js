...
contract('Generic Pool Party ICO', function (accounts) {
    ...
    describe('Generic Sale', function () {
        ...
        it("should create new Pool Party", async () => {
            await poolPartyFactory.createNewPoolParty("api.test.foreground.io", "Pool name", "Pool description", web3.toWei("15"), "QmNd7C8BwUqfhfq6xyRRMzxk1v3dALQjDxwBg4yEJkU24D", {from: _deployer});
