...
contract('Generic Pool Party ICO', function (accounts) {
    ...
    describe('Generic Sale', function () {
        ...
        /*it.skip("Should kick user", async () => {
            ...
            await expectThrow(icoPoolPartyContract.kickUser(investor3, KickReason.Other, {from: accounts[7]}));
            await sleep(3000);
            await icoPoolPartyContract.kickUser(investor3, KickReason.Other, {from: accounts[7]});
