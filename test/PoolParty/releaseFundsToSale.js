...
contract('PoolParty', (accounts) => {
    ...
    describe('Function: releaseFundsToSale() - Generic Sale: 0% fee. ', () => {
        beforeEach(async () => {
            ...
            await poolPartyFactory.createNewPoolParty("zero.fee.test", "Pool name", "Pool description", {from: _investor1});
    ...
    describe('Function: releaseFundsToSale() - Generic Sale: Waive Fee. ', () => {
        beforeEach(async () => {
            ...
            await poolPartyFactory.createNewPoolParty("waive.fee.test", "Pool name", "Pool description", {from: _investor1});
