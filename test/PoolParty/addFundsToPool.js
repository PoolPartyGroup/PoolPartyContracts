...
contract('PoolParty', (accounts) => {
    ...
    describe('Function: addFundsToPool()', () => {
        it('should add funds to pool when in "Open" status', async () => {
            ...
            assert.equal((await poolParty.participants(_investor1))[ParticipantStruct.amountContributed], web3.toWei("0.5"), "Incorrect investment amount balance");
            assert.equal(await poolParty.totalPoolContributions(), web3.toWei("0.5"), "Incorrect total investment balance");

            await poolParty.addFundsToPool(1, {from: _investor2, value: web3.toWei("0.5")});
            assert.equal((await poolParty.participants(_investor2))[ParticipantStruct.amountContributed], web3.toWei("0.5"), "Incorrect investment amount balance");
            assert.equal(await poolParty.totalPoolContributions(), web3.toWei("1"), "Incorrect total investment balance");
        });
        ...
        it('should add funds to pool when in "Watermark" status', async () => {
            ...
            await poolParty.addFundsToPool(1, {from: _investor2, value: web3.toWei("0.5")});
            assert.equal((await poolParty.participants(_investor2))[ParticipantStruct.amountContributed], web3.toWei("0.5"), "Incorrect investment amount balance");
            assert.equal(await poolParty.totalPoolContributions(), web3.toWei("1.5"), "Incorrect total investment balance");
        });
        ...
        it('should attempt to add funds to pool when in "In Review" status', async () => {
            ...
            await expectThrow(poolParty.addFundsToPool(1, {from: _investor2, value: web3.toWei("0.5")}));
            assert.notEqual((await poolParty.participants(_investor2))[ParticipantStruct.amountContributed], web3.toWei("0.5"), "Incorrect investment amount balance");
            assert.notEqual(await poolParty.totalPoolContributions(), web3.toWei("1.5"), "Incorrect total investment balance");
        ...
        it('should calculate the correct number of pool participants', async () => {
            ...
            await poolParty.addFundsToPool(1, {from: _investor3, value: web3.toWei("0.5")});
        ...
        it('should confirm correct values in investors struct', async () => {
            ...
            await poolParty.addFundsToPool(1, {from: _investor1, value: web3.toWei("0.5")});
            assert.equal(await poolParty.poolParticipants(), 1, "Incorrect number of participants");
            assert.equal((await poolParty.participants(_investor1))[ParticipantStruct.amountContributed], web3.toWei("0.5"), "Incorrect investor balance");
            ...
            await poolParty.addFundsToPool(1, {from: _investor2, value: web3.toWei("0.5")});
            assert.equal(await poolParty.poolParticipants(), 2, "Incorrect number of participants");
            assert.equal((await poolParty.participants(_investor2))[ParticipantStruct.amountContributed], web3.toWei("0.5"), "Incorrect investor balance");
    ...
    describe('Function: leavePool()', () => {
        ...
        it('should leave pool and be removed from the list', async () => {
            ...
            assert.equal(await poolParty.totalPoolContributions(), web3.toWei("2"), "Incorrect total investment balance");
    ...
    describe('Function: configurePool()', () => {
        ...
        it('should attempt to configure pool with non authorized configuration address', async () => {
            await poolParty.addFundsToPool(2, {from: _investor2, value: web3.toWei("1")});
            await poolParty.setAuthorizedConfigurationAddress({from: _investor1});
