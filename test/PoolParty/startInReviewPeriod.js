...
contract('PoolParty', (accounts) => {
    ...
    beforeEach(async () => {
        ...
        await poolPartyFactory.createNewPoolParty("api.test.foreground.io", "Pool name", "Pool description", web3.toWei("1"), web3.toWei("0.5"), web3.toWei("0.8"), "", {from: _investor1});
